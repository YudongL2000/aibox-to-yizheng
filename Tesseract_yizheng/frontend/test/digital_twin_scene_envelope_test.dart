...
void main() {
  ...
  test('normalizes workflow template model URLs to Flutter Web bundle path', () {
    expect(
      DigitalTwinModelItem.normalizeFlutterWebModelAssetUrl(
        '/assets/models/base.glb',
      ),
      '/assets/assets/models/base.glb',
    );
    expect(
      DigitalTwinModelItem.normalizeFlutterWebModelAssetUrl(
        'assets/models/base.glb',
    ...
    final item = DigitalTwinModelItem.fromJson(<String, dynamic>{
      'id': 'model_5',
      'url': '/assets/models/base.glb',
      'position': <double>[0, 0, 0],
      'rotation': <double>[0, 0, 0],
    });
    expect(item.url, '/assets/assets/models/base.glb');
  });
}
