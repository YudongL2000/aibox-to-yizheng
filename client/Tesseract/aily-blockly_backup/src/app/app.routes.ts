...
export const routes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'tesseract-studio',
                loadComponent: () => import('./editors/tesseract-studio/tesseract-studio.component').then(m => m.TesseractStudioComponent)
            },
            {
                path: 'code-editor',
