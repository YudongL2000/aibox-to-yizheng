	...
	>
		...
		<div class="header">
			<div class="header-left">
				<!-- 绿色闪电图标 -->
				<N8nIcon icon="bolt" size="small" class="trigger-icon" />
				<!-- TRIGGER 标签 -->
		...
		<div class="content">
			...
			<!-- 副标题：小号灰色 -->
			<div class="subtitle">{{ options.subtitle || 'FN: Schedule Trigger' }}</div>
		</div>
		</div>
	</N8nTooltip>
</template>
