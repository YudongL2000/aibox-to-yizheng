...
class _InputAlertUntilWidgetState extends State<InputAlertUntilWidget> {
  ...
  Widget _inputWidget() {
    final SpatialThemeData spatial = context.spatial;
    final Color tone = spatial.status(SpatialStatusTone.info);
    return Container(
        width: 300,
        height: 350,
        ...
        child: Column(children: [
          Text(
            widget.title ?? "",
            style: TextStyle(fontSize: 14, color: spatial.palette.textPrimary),
          ),
          SizedBox(
            height: 15,
          ),
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            spatial.palette.textPrimary.withValues(alpha: 0.05),
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          "确定",
                          style: TextStyle(
                              fontSize: 14, color: spatial.palette.textInverse),
                        ),
                      ),
                    ),
                  ),
