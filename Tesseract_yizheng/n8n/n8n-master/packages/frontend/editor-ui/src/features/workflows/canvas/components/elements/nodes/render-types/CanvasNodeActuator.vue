...
<template>
	...
	>
		...
		<div class="custom-node actuator-node">
		<!-- 左侧紫色竖线 -->
		...
		<div class="header">
			<div class="header-left">
				<!-- 紫色执行器图标 -->
				<N8nIcon icon="hand-paper" size="small" class="type-icon" />
				<!-- ACTUATOR 标签 -->
				<span class="type-label">ACTUATOR</span>
			</div>
			<!-- 右上角淡紫色点 -->
		...
		<div class="content">
			...
			<!-- 副标题：小号灰色 -->
			<div class="subtitle">{{ options.subtitle || 'FN: Actuator' }}</div>
		</div>
		</div>
	</N8nTooltip>
</template>
