...
const DEFAULT_PIXEL_COLOURS: PixelColours = {
    empty: 'var(--text-inverse)',
    filled: 'var(--shell-shell-violet)',
};
...
.canvasContainer-u8g2 {
  border: 2px solid var(--shell-shell-divider);
  margin: 10px;
...
.dimensionContainer-u8g2 {
  ...
  padding: 4px;
  border-radius: 4px;
  border: 1px solid var(--shell-control-text);
...
.dimensionInput-u8g2 {
  ...
  width: 45px;
  padding: 4px 0px;
  border: 1px solid var(--shell-shell-divider);
  border-radius: 3px;
  font-size: 12px;
  text-align: center;
  color: var(--text-muted);
...
.dimensionInput-u8g2:focus {
  ...
  box-shadow: 0 0 0 1px color-mix(in srgb, var(--sem-info) 30%, transparent);
...
.controlButton-u8g2:hover {
  ...
  border-color: var(--shell-control-text-muted);
}
