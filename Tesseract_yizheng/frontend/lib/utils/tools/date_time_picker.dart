...
class HXDateTimePicker extends FormField<String> {
  HXDateTimePicker({
    Key? key,
...
class _DateTimePickerState extends FormFieldState<String> {
  ...
  @override
  HXDateTimePicker get widget => super.widget as HXDateTimePicker;
  ...
  void initValues() {
    ...
    if (lsValue != null && lsValue != '' && lsValue != 'null') {
      if (widget.type != DateTimePickerType.time) {
        ...
        _sTime = DateFormat('HH:mm:ss', languageCode).format(_dDate);
  ...
  @override
  void didUpdateWidget(HXDateTimePicker oldWidget) {
