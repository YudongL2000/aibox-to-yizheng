 ...
 * [OUTPUT]: 对外提供 dark-first Spatial shell 下的 agent-ui 主应用
 * [POS]: agent-ui 的页面级装配器，负责连接 AI 健康测试、按交互锚定的流式聊天、n8n 预览与统一 shell 布局
...
function App() {
  ...
  return (
    <div className="flex h-screen flex-col gap-4 overflow-hidden p-4 lg:p-5">
      ...
      <div className="flex flex-1 flex-col gap-4 lg:flex-row min-h-0">
        <div className="flex flex-1 flex-col gap-4 min-h-0">
          ...
          <div className="flex-[2] min-h-0">
            <Suspense
              fallback={<div className="sp-panel h-full rounded-[28px] p-6 sp-text-muted">Loading...</div>}
            >
              <N8nIframe
