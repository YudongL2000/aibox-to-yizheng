...
- 2026-04-12: agent-factory.ts / workflow-service.ts / config-agent-service.ts 改为按请求解析 n8n API 配置，修复 backend 先起、embedded n8n 后起时 workflow create / confirm-node 继续命中旧凭据的时序问题。
