...
import { _ as onKeyDown, gt as useI18n, it as useThrottleFn, ot as watchOnce, st as watchThrottled, y as onKeyUp } from "./_MapCache-BpDQM3eE.js";
import { Ai as N8nText_default, Et as N8nLink_default, Gt as N8nIconButton_default, L as N8nPopover_default, Lt as N8nTooltip_default, Ni as N8nIcon_default, Nt as useRoute, Pt as useRouter, Wt as createEventBus, j as N8nSticky_default, ji as N8nButton_default, xt as useDeviceSupport, yt as N8nActionDropdown_default } from "./src-Hou_zQaF.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { $n as useTemplatesDataQualityStore, An as updateViewportToContainNodes, At as useNodeHelpers, Bn as clamp, Fi as getTriggerNodeServiceName, Fn as _sfc_main$4, Ft as injectWorkflowState, Gn as getSmoothStepPath, Hn as getBoundsofRects, In as _sfc_main$1, Jn as useVueFlow, Kn as isMacOs, Ln as _sfc_main$3, Mn as NodeId, Nn as PanelPosition, Ot as environments_store_default, Pn as Position, Pt as useNDVStore, Qn as trackTemplatesClick, Rn as _sfc_main$d, S as useNodeTypesStore, Tn as getMousePosition, Un as getConnectedEdges, Vn as getBezierPath, Wn as getRectOfNodes, Xn as TemplateClickSource, Yn as wheelDelta, Zn as isExtraTemplateLinksExperimentEnabled, Zr as isValidNodeConnectionType, _n as GRID_SIZE, dn as useTemplatesStore, fa as globalLinkActionsEventBus, fr as isOutsideSelected, gi as useSettingsStore, hn as DEFAULT_NODE_SIZE, ii as useHistoryStore, jn as MarkerType, jr as v4_default, jt as useTelemetry, la as nodeViewEventBus, n as useUIStore, ni as CanvasNodeDirtiness, nr as useToast, o as useWorkflowsStore, pn as CONFIGURATION_NODE_RADIUS, pr as sanitizeHtml, qn as useGetPointerPosition, ri as CanvasNodeRenderType, rr as useStyles, sr as useSourceControlStore, ta as isPresent, ti as CanvasConnectionMode, vn as PUSH_NODES_OFFSET, yn as calculateNodeSize, zn as _sfc_main$f } from "./ui.store-Cpjm3B-h.js";
import { S as TitledList_default } from "./ParameterInputList-BXbARWot.js";
import { Ba as NodeConnectionTypes, Bi as mapConnectionsByDestination, Eo as getResourcePermissions, Go as EXPERIMENT_TEMPLATES_DATA_QUALITY_KEY, Io as VIEWS, Ji as getNodeOutputs, M as CUSTOM_API_CALL_KEY, Pt as CHAT_TRIGGER_NODE_TYPE, Qs as ExpressionLocalResolveContextSymbol, Sa as isCommunityPackageName, Xn as SIMULATE_NODE_TYPE, Xs as CanvasNodeHandleKey, Ys as CanvasKey, Zn as SIMULATE_TRIGGER_NODE_TYPE, Zs as CanvasNodeKey, co as SEND_AND_WAIT_OPERATION, do as WAIT_INDEFINITELY, ea as getSubworkflowId, eo as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, fi as extractReferencesInNodeExpressions, fo as WEBHOOK_NODE_TYPE, hs as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, ia as isNodeWithWorkflowSelector, jn as NOT_DUPLICATABLE_NODE_TYPES, lr as WAIT_NODE_TYPE, nr as STICKY_NODE_TYPE, oi as buildAdjacencyList, po as require_isEqual, qi as getNodeInputs, ra as isExecutable, rn as FORM_NODE_TYPE, si as parseExtractableSubgraphSelection, vt as NODE_CREATOR_OPEN_SOURCES, yc as CANVAS_EXECUTION_DATA_THROTTLE_DURATION, zn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES } from "./constants-CpkFUv1J.js";
...
import { t as usePinnedData } from "./usePinnedData-Q9Fk_H_F.js";
import { t as useNodeCreatorStore } from "./nodeCreator.store-CkUcKcrl.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections, r as insertSpacersBetweenEndpoints, s as mapLegacyEndpointsToCanvasConnectionPort, t as checkOverlap } from "./canvas.utils-5q3Oj_ss.js";
import { t as getNodeIconSource } from "./nodeIcon-DCAOFyUj.js";
import { a as useLogsStore, i as useExperimentalNdvStore, t as useCanvasOperations } from "./useCanvasOperations-yGA-Jvmi.js";
import { t as NodeIcon_default } from "./NodeIcon-C7QOv9AW.js";
import { t as useTelemetryContext } from "./useTelemetryContext-oD_j2HMz.js";
import { r as useNodeDirtiness, t as useRunWorkflow } from "./useRunWorkflow-D8LbgKCB.js";
import { t as useCollaborationStore } from "./collaboration.store-Dp1OxT4u.js";
import { t as NodeSettings_default } from "./NodeSettings-BlJP3gL3.js";
import { t as KeyboardShortcutTooltip_default } from "./KeyboardShortcutTooltip-BvxEF_bQ.js";
import { t as useKeybindings } from "./useKeybindings-B8mfgi8L.js";
...
var _hoisted_1$23 = { key: 4 };
var _hoisted_2$13 = { key: 6 };
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return unref(isNotInstalledCommunityNode) && !isDemoRoute.value ? (openBlock(), createElementBlock("div", {
				...
				_: 1
			})], 2)) : unref(executionStatus) === "unknown" ? (openBlock(), createElementBlock("div", _hoisted_1$23)) : unref(hasPinnedData) && !unref(nodeHelpers).isProductionExecutionPreview.value ? (openBlock(), createElementBlock("div", {
				key: 5,
				...
				icon: "node-pin",
				size: __props.size
			}, null, 8, ["size"])], 2)) : dirtiness.value !== void 0 ? (openBlock(), createElementBlock("div", _hoisted_2$13, [createVNode(unref(N8nTooltip_default), {
				"show-after": 500,
				placement: "bottom"
			}, {
...
var _hoisted_1$21 = { "data-test-id": "canvas-node-status-always-output-data" };
var _hoisted_2$11 = { "data-test-id": "canvas-node-status-execute-once" };
var _hoisted_3$15 = { "data-test-id": "canvas-node-status-retry-on-fail" };
var _hoisted_4$8 = { "data-test-id": "canvas-node-status-continue-on-error" };
var size = "medium";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.settingsIcons) }, [
				node$1.value?.alwaysOutputData ? (openBlock(), createBlock(unref(N8nTooltip_default), { key: 0 }, {
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_1$21, [createVNode(unref(N8nIcon_default), {
						icon: "always-output-data",
						size
					})])]),
					_: 1
				...
				node$1.value?.executeOnce ? (openBlock(), createBlock(unref(N8nTooltip_default), { key: 1 }, {
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_2$11, [createVNode(unref(N8nIcon_default), {
						icon: "execute-once",
						size
					})])]),
					_: 1
				...
				node$1.value?.retryOnFail ? (openBlock(), createBlock(unref(N8nTooltip_default), { key: 2 }, {
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_3$15, [createVNode(unref(N8nIcon_default), {
						icon: "retry-on-fail",
						size
					})])]),
					_: 1
				...
				node$1.value?.onError === "continueRegularOutput" || node$1.value?.onError === "continueErrorOutput" ? (openBlock(), createBlock(unref(N8nTooltip_default), { key: 3 }, {
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_4$8, [createVNode(unref(N8nIcon_default), {
						icon: "continue-on-error",
						size
					})])]),
					_: 1
...
var _hoisted_1$20 = ["data-test-id"];
...
const disabled = "_disabled_xjtm2_218";
...
var _hoisted_1$19 = { class: "hover-info-row type-row" };
var _hoisted_2$10 = { class: "type-label" };
var _hoisted_3$14 = { class: "hover-info-row" };
var _hoisted_4$7 = { class: "value" };
var _hoisted_5$6 = { class: "hover-info-row" };
var _hoisted_6$6 = { class: "value" };
var _hoisted_7$1 = {
	key: 0,
	class: "hover-info-row"
};
var _hoisted_8$1 = { class: "value" };
var _hoisted_9$1 = {
	key: 1,
	class: "hover-info-row"
};
var _hoisted_10$1 = { class: "value" };
var _hoisted_11 = {
	key: 2,
	class: "hover-info-row"
};
var _hoisted_12 = { class: "value" };
var _hoisted_13 = {
	key: 3,
	class: "hover-info-row"
};
var _hoisted_14 = { class: "value" };
var _hoisted_15 = { class: "hover-info-row" };
var _hoisted_16 = { class: "value id" };
var _hoisted_17 = {
	key: 1,
	class: "hover-info-row"
};
...
var _hoisted_20 = { class: "value status" };
var CustomNodeHoverInfo_default = /* @__PURE__ */ __plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "CustomNodeHoverInfo",
	props: {
		nodeData: {},
		accentColor: {},
		typeLabel: {}
	...
	setup(__props) {
		const props = __props;
		const renderOptions = computed(() => props.nodeData.render?.options);
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				class: "custom-node-hover-info",
				style: normalizeStyle({ "--accent": __props.accentColor })
			}, [
				createBaseVNode("div", _hoisted_1$19, [createBaseVNode("span", _hoisted_2$10, toDisplayString(__props.typeLabel), 1)]),
				createBaseVNode("div", _hoisted_3$14, [_cache[0] || (_cache[0] = createBaseVNode("span", { class: "label" }, "名称", -1)), createBaseVNode("span", _hoisted_4$7, toDisplayString(__props.nodeData.name), 1)]),
				createBaseVNode("div", _hoisted_5$6, [_cache[1] || (_cache[1] = createBaseVNode("span", { class: "label" }, "节点类型", -1)), createBaseVNode("span", _hoisted_6$6, toDisplayString(__props.nodeData.type), 1)]),
				renderOptions.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
					renderOptions.value.title ? (openBlock(), createElementBlock("div", _hoisted_7$1, [_cache[2] || (_cache[2] = createBaseVNode("span", { class: "label" }, "标题", -1)), createBaseVNode("span", _hoisted_8$1, toDisplayString(renderOptions.value.title), 1)])) : createCommentVNode("", true),
					renderOptions.value.subtitle ? (openBlock(), createElementBlock("div", _hoisted_9$1, [_cache[3] || (_cache[3] = createBaseVNode("span", { class: "label" }, "描述", -1)), createBaseVNode("span", _hoisted_10$1, toDisplayString(renderOptions.value.subtitle), 1)])) : createCommentVNode("", true),
					renderOptions.value.displayName ? (openBlock(), createElementBlock("div", _hoisted_11, [_cache[4] || (_cache[4] = createBaseVNode("span", { class: "label" }, "显示名", -1)), createBaseVNode("span", _hoisted_12, toDisplayString(renderOptions.value.displayName), 1)])) : createCommentVNode("", true),
					renderOptions.value.nodeType ? (openBlock(), createElementBlock("div", _hoisted_13, [_cache[5] || (_cache[5] = createBaseVNode("span", { class: "label" }, "Node Type", -1)), createBaseVNode("span", _hoisted_14, toDisplayString(renderOptions.value.nodeType), 1)])) : createCommentVNode("", true)
				], 64)) : createCommentVNode("", true),
				createBaseVNode("div", _hoisted_15, [_cache[6] || (_cache[6] = createBaseVNode("span", { class: "label" }, "ID", -1)), createBaseVNode("span", _hoisted_16, toDisplayString(__props.nodeData.id), 1)]),
				__props.nodeData.disabled ? (openBlock(), createElementBlock("div", _hoisted_17, [..._cache[7] || (_cache[7] = [createBaseVNode("span", { class: "value status disabled" }, "已禁用", -1)])])) : __props.nodeData.execution?.running ? (openBlock(), createElementBlock("div", _hoisted_18, [..._cache[8] || (_cache[8] = [createBaseVNode("span", { class: "value status running" }, "运行中", -1)])])) : __props.nodeData.execution?.status ? (openBlock(), createElementBlock("div", _hoisted_19, [createBaseVNode("span", _hoisted_20, toDisplayString(__props.nodeData.execution.status), 1)])) : createCommentVNode("", true)
			], 4);
		};
	}
}), [["__scopeId", "data-v-f44f606c"]]);
var _hoisted_1$18 = { class: "custom-node trigger-node" };
var _hoisted_2$9 = { class: "header" };
var _hoisted_3$13 = { class: "header-left" };
var _hoisted_4$6 = { class: "content" };
var _hoisted_5$5 = { class: "main-title" };
var _hoisted_6$5 = { class: "subtitle" };
var CanvasNodeTrigger_default$1 = /* @__PURE__ */ __plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "CanvasNodeTrigger",
	setup(__props) {
		const node$1 = inject(CanvasNodeKey);
		const options = computed(() => node$1.data.value.render?.options || {});
		const nodeData = computed(() => node$1.data.value);
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(N8nTooltip_default), {
				placement: "top",
				"show-after": 300,
				...
				content: withCtx(() => [createVNode(CustomNodeHoverInfo_default, {
					"node-data": nodeData.value,
					"accent-color": "#00ff88",
					"type-label": "TRIGGER"
				}, null, 8, ["node-data"])]),
				default: withCtx(() => [createBaseVNode("div", _hoisted_1$18, [
					_cache[2] || (_cache[2] = createBaseVNode("div", { class: "left-accent" }, null, -1)),
					_cache[3] || (_cache[3] = createBaseVNode("div", { class: "corner-bracket corner-top-left" }, null, -1)),
					_cache[4] || (_cache[4] = createBaseVNode("div", { class: "corner-bracket corner-top-right" }, null, -1)),
					_cache[5] || (_cache[5] = createBaseVNode("div", { class: "corner-bracket corner-bottom-left" }, null, -1)),
					_cache[6] || (_cache[6] = createBaseVNode("div", { class: "corner-bracket corner-bottom-right" }, null, -1)),
					createBaseVNode("div", _hoisted_2$9, [createBaseVNode("div", _hoisted_3$13, [createVNode(unref(N8nIcon_default), {
						icon: "bolt",
						size: "small",
						class: "trigger-icon"
					}), _cache[0] || (_cache[0] = createBaseVNode("span", { class: "trigger-label" }, "TRIGGER", -1))]), _cache[1] || (_cache[1] = createBaseVNode("div", { class: "header-dot" }, null, -1))]),
					createBaseVNode("div", _hoisted_4$6, [createBaseVNode("div", _hoisted_5$5, toDisplayString(options.value.title || unref(node$1).data.value.name), 1), createBaseVNode("div", _hoisted_6$5, toDisplayString(options.value.subtitle || "FN: Schedule Trigger"), 1)])
				])]),
				_: 1
			});
		};
	}
}), [["__scopeId", "data-v-e7d4dc98"]]);
var _hoisted_1$17 = { class: "custom-node sensor-node" };
var _hoisted_2$8 = { class: "header" };
var _hoisted_3$12 = { class: "header-left" };
var _hoisted_4$5 = { class: "content" };
var _hoisted_5$4 = { class: "main-title" };
var _hoisted_6$4 = { class: "subtitle" };
var CanvasNodeSensor_default = /* @__PURE__ */ __plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "CanvasNodeSensor",
	setup(__props) {
		const node$1 = inject(CanvasNodeKey);
		const options = computed(() => node$1.data.value.render?.options || {});
		const nodeData = computed(() => node$1.data.value);
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(N8nTooltip_default), {
				...
				default: withCtx(() => [createBaseVNode("div", _hoisted_1$17, [
					_cache[2] || (_cache[2] = createBaseVNode("div", { class: "left-accent" }, null, -1)),
					_cache[3] || (_cache[3] = createBaseVNode("div", { class: "corner-bracket corner-top-left" }, null, -1)),
					_cache[4] || (_cache[4] = createBaseVNode("div", { class: "corner-bracket corner-top-right" }, null, -1)),
					_cache[5] || (_cache[5] = createBaseVNode("div", { class: "corner-bracket corner-bottom-left" }, null, -1)),
					_cache[6] || (_cache[6] = createBaseVNode("div", { class: "corner-bracket corner-bottom-right" }, null, -1)),
					createBaseVNode("div", _hoisted_2$8, [createBaseVNode("div", _hoisted_3$12, [createVNode(unref(N8nIcon_default), {
						icon: "camera",
						size: "small",
						class: "type-icon"
					}), _cache[0] || (_cache[0] = createBaseVNode("span", { class: "type-label" }, "SENSOR", -1))]), _cache[1] || (_cache[1] = createBaseVNode("div", { class: "header-dot" }, null, -1))]),
					createBaseVNode("div", _hoisted_4$5, [createBaseVNode("div", _hoisted_5$4, toDisplayString(options.value.title || unref(node$1).data.value.name), 1), createBaseVNode("div", _hoisted_6$4, toDisplayString(options.value.subtitle || "FN: Sensor"), 1)])
				])]),
				_: 1
			});
		};
	}
}), [["__scopeId", "data-v-526a1af0"]]);
var _hoisted_1$16 = { class: "custom-node processor-node" };
var _hoisted_2$7 = { class: "header" };
var _hoisted_3$11 = { class: "header-left" };
var _hoisted_4$4 = { class: "content" };
var _hoisted_5$3 = { class: "main-title" };
var _hoisted_6$3 = { class: "subtitle" };
var CanvasNodeProcessor_default = /* @__PURE__ */ __plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "CanvasNodeProcessor",
	setup(__props) {
		const node$1 = inject(CanvasNodeKey);
		const options = computed(() => node$1.data.value.render?.options || {});
		const nodeData = computed(() => node$1.data.value);
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(N8nTooltip_default), {
				...
				content: withCtx(() => [createVNode(CustomNodeHoverInfo_default, {
					"node-data": nodeData.value,
					"accent-color": "#3b82f6",
					"type-label": "PROCESSOR"
				}, null, 8, ["node-data"])]),
				default: withCtx(() => [createBaseVNode("div", _hoisted_1$16, [
					_cache[2] || (_cache[2] = createBaseVNode("div", { class: "left-accent" }, null, -1)),
					_cache[3] || (_cache[3] = createBaseVNode("div", { class: "corner-bracket corner-top-left" }, null, -1)),
					_cache[4] || (_cache[4] = createBaseVNode("div", { class: "corner-bracket corner-top-right" }, null, -1)),
					_cache[5] || (_cache[5] = createBaseVNode("div", { class: "corner-bracket corner-bottom-left" }, null, -1)),
					_cache[6] || (_cache[6] = createBaseVNode("div", { class: "corner-bracket corner-bottom-right" }, null, -1)),
					createBaseVNode("div", _hoisted_2$7, [createBaseVNode("div", _hoisted_3$11, [createVNode(unref(N8nIcon_default), {
						icon: "microchip",
						size: "small",
						class: "type-icon"
					}), _cache[0] || (_cache[0] = createBaseVNode("span", { class: "type-label" }, "PROCESSOR", -1))]), _cache[1] || (_cache[1] = createBaseVNode("div", { class: "header-dot" }, null, -1))]),
					createBaseVNode("div", _hoisted_4$4, [createBaseVNode("div", _hoisted_5$3, toDisplayString(options.value.title || unref(node$1).data.value.name), 1), createBaseVNode("div", _hoisted_6$3, toDisplayString(options.value.subtitle || "FN: Processor"), 1)])
				])]),
				_: 1
			});
		};
	}
}), [["__scopeId", "data-v-a51b02d3"]]);
var _hoisted_1$15 = { class: "custom-node logic-node" };
var _hoisted_2$6 = { class: "header" };
var _hoisted_3$10 = { class: "header-left" };
var _hoisted_4$3 = { class: "content" };
var _hoisted_5$2 = { class: "main-title" };
var _hoisted_6$2 = { class: "subtitle" };
var CanvasNodeLogic_default = /* @__PURE__ */ __plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "CanvasNodeLogic",
	setup(__props) {
		const node$1 = inject(CanvasNodeKey);
		const options = computed(() => node$1.data.value.render?.options || {});
		const nodeData = computed(() => node$1.data.value);
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(N8nTooltip_default), {
				...
				default: withCtx(() => [createBaseVNode("div", _hoisted_1$15, [
					_cache[2] || (_cache[2] = createBaseVNode("div", { class: "left-accent" }, null, -1)),
					_cache[3] || (_cache[3] = createBaseVNode("div", { class: "corner-bracket corner-top-left" }, null, -1)),
					_cache[4] || (_cache[4] = createBaseVNode("div", { class: "corner-bracket corner-top-right" }, null, -1)),
					_cache[5] || (_cache[5] = createBaseVNode("div", { class: "corner-bracket corner-bottom-left" }, null, -1)),
					_cache[6] || (_cache[6] = createBaseVNode("div", { class: "corner-bracket corner-bottom-right" }, null, -1)),
					createBaseVNode("div", _hoisted_2$6, [createBaseVNode("div", _hoisted_3$10, [createVNode(unref(N8nIcon_default), {
						icon: "code-branch",
						size: "small",
						class: "type-icon"
					}), _cache[0] || (_cache[0] = createBaseVNode("span", { class: "type-label" }, "P LOGIC", -1))]), _cache[1] || (_cache[1] = createBaseVNode("div", { class: "header-dot" }, null, -1))]),
					createBaseVNode("div", _hoisted_4$3, [createBaseVNode("div", _hoisted_5$2, toDisplayString(options.value.title || unref(node$1).data.value.name), 1), createBaseVNode("div", _hoisted_6$2, toDisplayString(options.value.subtitle || "FN: Logic"), 1)])
				])]),
				_: 1
			});
		};
	}
}), [["__scopeId", "data-v-91505de0"]]);
var _hoisted_1$14 = { class: "custom-node actuator-node" };
var _hoisted_2$5 = { class: "header" };
var _hoisted_3$9 = { class: "header-left" };
var _hoisted_4$2 = { class: "content" };
var _hoisted_5$1 = { class: "main-title" };
var _hoisted_6$1 = { class: "subtitle" };
var CanvasNodeActuator_default = /* @__PURE__ */ __plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "CanvasNodeActuator",
	setup(__props) {
		const node$1 = inject(CanvasNodeKey);
		const options = computed(() => node$1.data.value.render?.options || {});
		const nodeData = computed(() => node$1.data.value);
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(N8nTooltip_default), {
				...
				default: withCtx(() => [createBaseVNode("div", _hoisted_1$14, [
					_cache[2] || (_cache[2] = createBaseVNode("div", { class: "left-accent" }, null, -1)),
					_cache[3] || (_cache[3] = createBaseVNode("div", { class: "corner-bracket corner-top-left" }, null, -1)),
					_cache[4] || (_cache[4] = createBaseVNode("div", { class: "corner-bracket corner-top-right" }, null, -1)),
					_cache[5] || (_cache[5] = createBaseVNode("div", { class: "corner-bracket corner-bottom-left" }, null, -1)),
					_cache[6] || (_cache[6] = createBaseVNode("div", { class: "corner-bracket corner-bottom-right" }, null, -1)),
					createBaseVNode("div", _hoisted_2$5, [createBaseVNode("div", _hoisted_3$9, [createVNode(unref(N8nIcon_default), {
						icon: "hand-paper",
						size: "small",
						class: "type-icon"
					}), _cache[0] || (_cache[0] = createBaseVNode("span", { class: "type-label" }, "ACTUATOR", -1))]), _cache[1] || (_cache[1] = createBaseVNode("div", { class: "header-dot" }, null, -1))]),
					createBaseVNode("div", _hoisted_4$2, [createBaseVNode("div", _hoisted_5$1, toDisplayString(options.value.title || unref(node$1).data.value.name), 1), createBaseVNode("div", _hoisted_6$1, toDisplayString(options.value.subtitle || "FN: Actuator"), 1)])
				])]),
				_: 1
			});
		};
	}
}), [["__scopeId", "data-v-c5878f2c"]]);
		...
		const Render = () => {
			...
			switch (renderType$1) {
				...
				case CanvasNodeRenderType.Trigger:
					Component = CanvasNodeTrigger_default$1;
					break;
				case CanvasNodeRenderType.Sensor:
					Component = CanvasNodeSensor_default;
					break;
				case CanvasNodeRenderType.Processor:
					Component = CanvasNodeProcessor_default;
					break;
				case CanvasNodeRenderType.Logic:
					Component = CanvasNodeLogic_default;
					break;
				case CanvasNodeRenderType.Actuator:
					Component = CanvasNodeActuator_default;
					break;
...
var CanvasHandlePlus_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			...
			}, null, -1))], 10, _hoisted_3$8)], 14, _hoisted_1$13);
		};
	}
});
...
var CanvasHandleNonMainInput_vue_vue_type_style_index_0_lang_module_default = {
	handle: "_handle_65byp_123",
	label: "_label_65byp_130",
	required: "_required_65byp_144"
};
...
var CanvasHandleNonMainOutput_vue_vue_type_style_index_0_lang_module_default = {
	handle: "_handle_vom2b_123",
	label: "_label_vom2b_130",
	required: "_required_vom2b_143"
};
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("svg", {
				...
				renderSlot(_ctx.$slots, "pattern-container", { id: patternId.value }, () => [createBaseVNode("pattern", {
					...
					height: "100%",
					fill: _ctx.bgColor
				}, null, 8, _hoisted_3$7)])) : createCommentVNode("", true)])], 8, _hoisted_1$9)]),
				createBaseVNode("rect", {
					x: _ctx.x,
					y: _ctx.y,
					width: "100%",
...
var CanvasEdgeTooltip_vue_vue_type_style_index_0_lang_module_default = { tooltipContainer: "_tooltipContainer_iprnb_123" };
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				key: 0,
				content: unref(i18n).baseText("node.add")
			}, {
				default: withCtx(() => [createVNode(unref(N8nIconButton_default), {
...
var CanvasEdge_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		function getNodeThemeColor(nodeId) {
			const node$1 = getNodes.value.find((n) => n.id === nodeId);
			if (!node$1) return "rgba(255, 255, 255, 0.6)";
			switch (node$1.data?.render?.type) {
				case CanvasNodeRenderType.Processor: return "#3b82f6";
				case CanvasNodeRenderType.Actuator: return "#a855f7";
				case CanvasNodeRenderType.Logic: return "#f97316";
				case CanvasNodeRenderType.Sensor: return "#06b6d4";
				case CanvasNodeRenderType.Trigger: return "#00ff88";
		...
		const particleStreamStyle = computed(() => ({
			...
			opacity: delayedHovered.value ? .9 : .5
		}));
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [createBaseVNode("g", mergeProps({
				...
				createBaseVNode("defs", null, [createBaseVNode("linearGradient", {
					...
					createBaseVNode("stop", {
						offset: "0%",
						"stop-color": sourceNodeColor.value,
						"stop-opacity": "0"
					}, null, 8, _hoisted_3),
					createBaseVNode("stop", {
						offset: "20%",
					...
					createBaseVNode("stop", {
						offset: "50%",
						"stop-color": targetNodeColor.value,
						"stop-opacity": "1"
					}, null, 8, _hoisted_6),
					createBaseVNode("stop", {
						offset: "80%",
				...
				renderSlot(_ctx.$slots, "highlight", normalizeProps(guardReactiveProps({ segments: segments.value }))),
				...
				(openBlock(true), createElementBlock(Fragment, null, renderList(segments.value, (segment, index) => {
					return openBlock(), createElementBlock("path", {
						...
						d: segment[0],
						class: normalizeClass(unref($style).particleStream),
						style: normalizeStyle(particleStreamStyle.value),
						fill: "none",
			...
			], 16, _hoisted_1), createVNode(unref(_sfc_main$3), null, {
				default: withCtx(() => [createBaseVNode("div", {
				...
				}, toDisplayString(__props.label), 3))], 46, _hoisted_10)]),
				_: 1
			})], 64);
		};
	}
...
var CanvasEdge_vue_vue_type_style_index_0_lang_module_default = {
	edge: "_edge_8xg19_123",
	particleStream: "_particleStream_8xg19_131",
	particleFlow: "_particleFlow_8xg19_1",
	edgeLabelWrapper: "_edgeLabelWrapper_8xg19_153",
	straight: "_straight_8xg19_159",
	edgeLabel: "_edgeLabel_8xg19_153"
};
...
var Canvas_default = /* @__PURE__ */ __plugin_vue_export_helper_default(Canvas_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": Canvas_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-c0ae1c51"]]);
function useCanvasMapping({ nodes, connections, workflowObject }) {
	...
	function getNodeNotesObject(node$1) {
		const rawNotes = node$1.notes;
		if (!rawNotes) return;
		if (typeof rawNotes === "object" && !Array.isArray(rawNotes)) return rawNotes;
		if (typeof rawNotes === "string") try {
	...
	function getNodeNotesTitle(node$1) {
		const title = getNodeNotesObject(node$1)?.title;
		return typeof title === "string" && title.trim().length > 0 ? title : void 0;
	}
	function getNodeNotesSubtitle(node$1) {
		const subtitle$1 = getNodeNotesObject(node$1)?.subtitle;
		return typeof subtitle$1 === "string" && subtitle$1.trim().length > 0 ? subtitle$1 : void 0;
	}
	function getNodeNotesFunction(node$1) {
		const func = getNodeNotesObject(node$1)?.function;
		return typeof func === "string" && func.trim().length > 0 ? func : void 0;
	}
	...
	function createTriggerRenderType(node$1) {
		const nodeType = nodeTypeDescriptionByNodeId.value[node$1.id];
		const icon$1 = getNodeIconSource(nodeType ?? node$1.type, node$1);
		const notesTitle = getNodeNotesTitle(node$1);
		const notesSubtitle = getNodeNotesSubtitle(node$1);
		const notesFunction = getNodeNotesFunction(node$1);
		const subtitle$1 = nodeSubtitleById.value[node$1.id] ?? "";
		let finalSubtitle = notesSubtitle ?? notesFunction ?? subtitle$1;
		if (!finalSubtitle && nodeType) {
			finalSubtitle = `FN: ${nodeType.displayName ?? nodeType.name.replace("n8n-nodes-base.", "")}`;
			if (node$1.type === "n8n-nodes-base.scheduleTrigger" && node$1.parameters.rule) {
				const rule = node$1.parameters.rule;
				if (rule.interval && rule.interval.length > 0) {
					const interval$1 = rule.interval[0];
					if (interval$1.field === "seconds") finalSubtitle += ` (${interval$1.expression}s)`;
				}
			}
		}
		if (node$1.type === "n8n-nodes-base.webhook" && !finalSubtitle) finalSubtitle = `FN: Webhook (${node$1.parameters.httpMethod ?? "POST"} /${node$1.parameters.path ?? ""})`;
		return {
			type: CanvasNodeRenderType.Trigger,
			options: {
				icon: icon$1,
				title: notesTitle ?? node$1.name,
				subtitle: finalSubtitle || "TRIGGER",
				nodeType: node$1.type,
				displayName: nodeType?.displayName ?? node$1.name,
				httpMethod: node$1.parameters.httpMethod,
				path: node$1.parameters.path
			}
		};
	}
	function createProcessorRenderType(node$1) {
		const nodeType = nodeTypeDescriptionByNodeId.value[node$1.id];
		const icon$1 = getNodeIconSource(nodeType ?? node$1.type, node$1);
		const notesTitle = getNodeNotesTitle(node$1);
		const notesSubtitle = getNodeNotesSubtitle(node$1);
		...
		const subtitle$1 = nodeSubtitleById.value[node$1.id] ?? "";
		let finalSubtitle = notesSubtitle ?? notesFunction ?? subtitle$1;
		if (!finalSubtitle && nodeType) finalSubtitle = `FN: ${nodeType.displayName ?? nodeType.name.replace("n8n-nodes-base.", "")}`;
		return {
			type: CanvasNodeRenderType.Processor,
			options: {
				icon: icon$1,
				title: notesTitle ?? node$1.name,
				subtitle: finalSubtitle || "FN: Processor",
				nodeType: node$1.type,
				displayName: nodeType?.displayName ?? node$1.name
			}
		};
	}
	function createActuatorRenderType(node$1) {
		const nodeType = nodeTypeDescriptionByNodeId.value[node$1.id];
		const icon$1 = getNodeIconSource(nodeType ?? node$1.type, node$1);
		const notesTitle = getNodeNotesTitle(node$1);
		const notesSubtitle = getNodeNotesSubtitle(node$1);
		...
		if (!finalSubtitle && nodeType) finalSubtitle = `FN: ${nodeType.displayName ?? nodeType.name.replace("n8n-nodes-base.", "")}`;
		return {
			type: CanvasNodeRenderType.Actuator,
			options: {
				icon: icon$1,
				title: notesTitle ?? node$1.name,
				subtitle: finalSubtitle || "FN: Actuator",
				nodeType: node$1.type,
				displayName: nodeType?.displayName ?? node$1.name
			}
		};
	}
	function createLogicRenderType(node$1) {
		const nodeType = nodeTypeDescriptionByNodeId.value[node$1.id];
		const icon$1 = getNodeIconSource(nodeType ?? node$1.type, node$1);
		const notesTitle = getNodeNotesTitle(node$1);
		const notesSubtitle = getNodeNotesSubtitle(node$1);
		...
		if (!finalSubtitle && nodeType) finalSubtitle = `FN: ${nodeType.displayName ?? nodeType.name.replace("n8n-nodes-base.", "")}`;
		return {
			type: CanvasNodeRenderType.Logic,
			options: {
				icon: icon$1,
				title: notesTitle ?? node$1.name,
				subtitle: finalSubtitle || "FN: Logic",
				nodeType: node$1.type,
				displayName: nodeType?.displayName ?? node$1.name
			}
		};
	}
	function createSensorRenderType(node$1) {
		const nodeType = nodeTypeDescriptionByNodeId.value[node$1.id];
		const icon$1 = getNodeIconSource(nodeType ?? node$1.type, node$1);
		const notesTitle = getNodeNotesTitle(node$1);
		const notesSubtitle = getNodeNotesSubtitle(node$1);
		...
		if (!finalSubtitle && nodeType) finalSubtitle = `FN: ${nodeType.displayName ?? nodeType.name.replace("n8n-nodes-base.", "")}`;
		return {
			type: CanvasNodeRenderType.Sensor,
			options: {
				icon: icon$1,
				title: notesTitle ?? node$1.name,
				subtitle: finalSubtitle || "FN: Sensor",
				nodeType: node$1.type,
				displayName: nodeType?.displayName ?? node$1.name
			}
		};
	...
	function shouldUseCustomRenderType(node$1) {
		const nodeName = node$1.name.toLowerCase();
		if (isTriggerNodeById.value[node$1.id] || node$1.type === "n8n-nodes-base.scheduleTrigger") return CanvasNodeRenderType.Trigger;
		if (node$1.type === "n8n-nodes-base.if" || node$1.type === "n8n-nodes-base.splitInBatches" || node$1.type === "n8n-nodes-base.switch" || node$1.type === "n8n-nodes-base.filter") return CanvasNodeRenderType.Logic;
		if (node$1.type === "n8n-nodes-base.set") return CanvasNodeRenderType.Processor;
		if (node$1.type === "n8n-nodes-base.httpRequest") return CanvasNodeRenderType.Sensor;
		if (node$1.type === "n8n-nodes-base.code") return CanvasNodeRenderType.Actuator;
		if (nodeName.includes("摄像头输入") || nodeName.includes("视觉环境快照")) return CanvasNodeRenderType.Sensor;
		if (nodeName.includes("麦克风输入") || nodeName.includes("语音音频拾取")) return CanvasNodeRenderType.Sensor;
		for (const mapping of [
			{
				old: "set camera payload",
				new: "图像规格标准化"
			},
			{
				old: "yolov8",
		...
		]) if (nodeName.includes(mapping.old) || nodeName.includes(mapping.new)) return CanvasNodeRenderType.Processor;
		if (nodeName.includes("判断") || nodeName.includes("if") || nodeName.includes("switch") || nodeName.includes("filter") || nodeName.includes("split")) return CanvasNodeRenderType.Logic;
		for (const mapping of [
			{
				old: "屏幕emoji显示",
				new: "面部表情投射"
		...
		]) if (nodeName.includes(mapping.old) || nodeName.includes(mapping.new)) return CanvasNodeRenderType.Actuator;
		return null;
	}
	const renderTypeByNodeId = computed(() => nodes.value.reduce((acc, node$1) => {
		...
		const customRenderType = shouldUseCustomRenderType(node$1);
		if (customRenderType) switch (customRenderType) {
			case CanvasNodeRenderType.Trigger:
				acc[node$1.id] = createTriggerRenderType(node$1);
				break;
			case CanvasNodeRenderType.Sensor:
				acc[node$1.id] = createSensorRenderType(node$1);
				break;
			case CanvasNodeRenderType.Processor:
				acc[node$1.id] = createProcessorRenderType(node$1);
				break;
			case CanvasNodeRenderType.Logic:
				acc[node$1.id] = createLogicRenderType(node$1);
				break;
			case CanvasNodeRenderType.Actuator:
				acc[node$1.id] = createActuatorRenderType(node$1);
				break;
			default: acc[node$1.id] = createDefaultNodeRenderType(node$1);
		}
		else acc[node$1.id] = createDefaultNodeRenderType(node$1);
		return acc;
	}, {}) ?? {});
...
export { CanvasNode_default as a, CanvasBackground_default as i, Canvas_default as n, useGlobalLinkActions as o, CanvasEdge_default as r, useWorkflowExtraction as s, useCanvasMapping as t };
