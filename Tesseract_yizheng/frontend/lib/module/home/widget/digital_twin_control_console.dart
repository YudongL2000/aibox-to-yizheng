...
class DigitalTwinControlConsole extends StatelessWidget {
      ...
      builder: (BuildContext context, _) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            color: SpatialDesignTokens.darkSurface,
            borderRadius: BorderRadius.circular(SpatialDesignTokens.radiusLg),
            border: Border.all(
              color: SpatialDesignTokens.darkBorderSolid,
              width: 1,
            ),
          ),
          child: Column(
            ...
            children: <Widget>[
                    ...
                    children: <Widget>[
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(
                            color: SpatialDesignTokens.darkTextSecondary,
                            fontSize: 12,
                            letterSpacing: 1,
                      ...
                      _buildInspectorBadge(
                        modeLabel,
                        SpatialDesignTokens.darkSemInfo,
                      ),
                      const SizedBox(width: 8),
                      _buildInspectorBadge(
                        selectedModel?.id ?? '未选中组件',
                        selectedModel != null
                            ? SpatialDesignTokens.darkSemSuccess
                            : SpatialDesignTokens.darkTextSecondary,
                      ),
                    ],
                  ),
                ),
              ...
              const Divider(
                color: SpatialDesignTokens.darkBorderDashed,
                height: 1,
                thickness: 1,
              ),
              Expanded(
  ...
  Color _connectionColorForModel(DigitalTwinModelItem model) {
    switch (_connectionLabelForModel(model)) {
      case '已连接':
        return SpatialDesignTokens.darkSemSuccess;
      case '未连接':
        return SpatialDesignTokens.darkSemDanger;
      default:
        return SpatialDesignTokens.darkTextSecondary;
    }
  }
  ...
  Widget _buildTransformInspector(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: SpatialDesignTokens.darkBgBase,
        borderRadius: BorderRadius.circular(SpatialDesignTokens.radiusMd),
        border: Border.all(
          color: SpatialDesignTokens.darkBorderSolid,
          width: 0.9,
        ),
      ...
      child: Column(
        ...
        children: <Widget>[
          Wrap(
            ...
            children: <Widget>[
              const Text(
                'MODEL INSPECTOR',
                style: TextStyle(
                  color: SpatialDesignTokens.darkSemInfo,
                  fontSize: 12,
                  fontWeight: FontWeight.w600,
                  letterSpacing: 1,
                  fontFamily: SpatialDesignTokens.fontMono,
              ...
              _buildInspectorBadge(
                ...
                controller.viewerReady
                    ? SpatialDesignTokens.darkSemSuccess
                    : SpatialDesignTokens.darkSemWarning,
              ),
              _buildInspectorBadge('全局坐标', SpatialDesignTokens.darkSemSuccess),
              if (selectedModel != null)
                Text(
                  '当前选中: ${selectedModel.id}',
                  style: TextStyle(
                    color: SpatialDesignTokens.darkTextPrimary.withValues(
                      alpha: 0.78,
                    ),
                    fontSize: 11,
                  ),
          ...
          Text(
            ...
            style: TextStyle(
              color:
                  SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.58),
              fontSize: 10,
            ),
          ),
          ...
          if (selectedModel != null) ...<Widget>[
            ...
            Text(
              ...
              style: TextStyle(
                color:
                    SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.54),
                fontSize: 10,
              ),
            ),
            const SizedBox(height: 10),
            ...
            if (!allowManualTransform) ...<Widget>[
              ...
              Text(
                ...
                style: TextStyle(
                  color: SpatialDesignTokens.darkTextPrimary
  ...
  Widget _buildSceneModelChip(int index, DigitalTwinModelItem model) {
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected
              ? SpatialDesignTokens.darkSemInfo.withOpacity(0.12)
              : SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.03),
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
            color: isSelected
                ? SpatialDesignTokens.darkSemInfo
                : SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.12),
          ),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            ...
            Text(
              ...
              style: TextStyle(
                color:
                    SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.72),
                fontSize: 11,
              ),
            ),
            if (model.interfaceId != null &&
              ...
              Text(
                ...
                style: TextStyle(
                  color: SpatialDesignTokens.darkSemSuccess.withOpacity(0.82),
                  fontSize: 10,
                  fontWeight: FontWeight.w600,
                ),
              ),
            ...
            Text(
              ...
              style: TextStyle(
                color:
                    SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.56),
                fontSize: 10,
              ),
            ),
  ...
  Widget _buildModeButton({
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selected
              ? SpatialDesignTokens.darkSemInfo.withOpacity(0.14)
              : SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.03),
          borderRadius: BorderRadius.circular(8),
          border: Border.all(
            color: selected
                ? SpatialDesignTokens.darkSemInfo
                : SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.14),
          ),
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: <Widget>[
            Icon(icon, size: 16, color: SpatialDesignTokens.darkSemInfo),
            const SizedBox(width: 6),
            Text(
              title,
              style: TextStyle(
                color: selected
                    ? SpatialDesignTokens.darkSemInfo
                    : SpatialDesignTokens.darkTextPrimary
  ...
  Widget _buildSelectedModelSummary(DigitalTwinModelItem model) {
    ...
    return Container(
      ...
      padding: const EdgeInsets.all(10),
      decoration: BoxDecoration(
        color: SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.03),
        borderRadius: BorderRadius.circular(10),
        border: Border.all(
            color: SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.12)),
      ),
      child: Wrap(
        spacing: 10,
        runSpacing: 8,
        ...
        children: <Widget>[
          ...
          if (controller.selectedSceneModelIsBase)
            _buildInspectorBadge('底座主体', SpatialDesignTokens.darkSemSuccess),
          if (!controller.selectedSceneModelIsBase &&
              interfaceId != null &&
          ...
          Text(
            ...
            style: TextStyle(
              color:
                  SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.68),
              fontSize: 11,
            ),
          ),
          Text(
          ...
          TextButton.icon(
            ...
            style: TextButton.styleFrom(
              foregroundColor: SpatialDesignTokens.darkSemInfo,
              padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 8),
              backgroundColor:
                  SpatialDesignTokens.darkSemInfo.withOpacity(0.08),
            ),
    ...
    if (controller.selectedSceneModelIsBase) {
      return Container(
        ...
        child: Text(
          ...
          style: TextStyle(
            color: SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.68),
            fontSize: 11,
          ),
        ),
      );
          ...
          DropdownButtonFormField<String>(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(8),
                borderSide:
                    const BorderSide(color: SpatialDesignTokens.darkSemInfo),
              ),
            ),
            dropdownColor: SpatialDesignTokens.darkSurface,
            style: const TextStyle(
                color: SpatialDesignTokens.darkTextPrimary, fontSize: 11),
        ...
        children: <Widget>[
          ...
          SliderTheme(
            data: SliderTheme.of(context).copyWith(
              activeTrackColor: SpatialDesignTokens.darkSemInfo,
              inactiveTrackColor:
                  SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.12),
              thumbColor: SpatialDesignTokens.darkSemInfo,
              overlayColor: SpatialDesignTokens.darkSemInfo.withOpacity(0.12),
              trackHeight: 4,
            ),
            child: Slider(
        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              const Text(
                ...
                style: TextStyle(
                  color: SpatialDesignTokens.darkSemSuccess,
                  fontSize: 11,
                  fontWeight: FontWeight.w600,
                  letterSpacing: 0.8,
                ),
              ...
              TextButton.icon(
                ...
                style: TextButton.styleFrom(
                  foregroundColor: SpatialDesignTokens.darkSemSuccess,
                  padding: const EdgeInsets.symmetric(
                    horizontal: 10,
                    vertical: 8,
                  ),
                  backgroundColor:
                      SpatialDesignTokens.darkSemSuccess.withOpacity(0.08),
                ),
                icon: const Icon(Icons.restart_alt, size: 16),
          ...
          if (interfacePreset != null &&
            ...
            Container(
              ...
              padding: const EdgeInsets.all(10),
              decoration: BoxDecoration(
                color: SpatialDesignTokens.darkSemInfo.withOpacity(0.05),
                borderRadius: BorderRadius.circular(8),
                border: Border.all(
                  color: SpatialDesignTokens.darkSemInfo.withOpacity(0.18),
                ),
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          _buildExportCard(
            ...
            accentColor: SpatialDesignTokens.darkSemInfo,
          ),
          const SizedBox(height: 10),
          _buildExportCard(
            context: context,
            ...
            accentColor: SpatialDesignTokens.darkSemSuccess,
          ),
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            targetPath,
            style: TextStyle(
              color: SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.5),
              fontSize: 10,
            ),
          ),
          const SizedBox(height: 8),
        ...
        SliderTheme(
          data: SliderTheme.of(context).copyWith(
            ...
            inactiveTrackColor:
                SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.12),
            thumbColor: SpatialDesignTokens.darkSemInfo,
            overlayColor: SpatialDesignTokens.darkSemInfo.withOpacity(0.15),
            trackHeight: 3,
          ),
          child: Slider(
            value: safeValue,
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          shape: BoxShape.circle,
          color: SpatialDesignTokens.darkTextPrimary
              .withValues(alpha: enabled ? 0.05 : 0.02),
          border: Border.all(
              color:
                  SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.12)),
        ),
        child: Icon(
          ...
          color: enabled
              ? SpatialDesignTokens.darkSemInfo
              : SpatialDesignTokens.darkTextPrimary.withValues(alpha: 0.26),
        ),
      ),
    );
  }
