...
import { isN8nApiAccessibleSync } from '../utils/n8n-availability';
import { createMcpContext } from '../utils/mcp-context';
import { InstanceContext } from '../../../../src/types/instance-context';
import { handleTriggerWebhookWorkflow } from '../../../../src/mcp/handlers-n8n-manager';
import { getN8nCredentials, hasWebhookUrls } from '../utils/credentials';

const describeWebhook = hasWebhookUrls() && isN8nApiAccessibleSync() ? describe : describe.skip;

describeWebhook('Integration: handleTriggerWebhookWorkflow', () => {
