...
export const enum CanvasNodeRenderType {
	...
	Trigger = 'triggerCustom', // 触发器节点 - 绿色主题
	Sensor = 'sensorCustom', // 感知器节点 - 青色主题
	Processor = 'processorCustom', // 处理器节点 - 蓝色主题
	Logic = 'logicCustom', // 逻辑/判断器节点 - 橙色主题
	Actuator = 'actuatorCustom', // 执行器节点 - 紫色主题
}
...
export type CanvasNodeTriggerRender = {
...
export type CanvasNodeProcessorRender = {
...
export type CanvasNodeActuatorRender = {
...
export type CanvasNodeLogicRender = {
...
export type CanvasNodeSensorRender = {
