...
class HxCheckBox extends StatefulWidget {
  final HXText? text;
  ...
  @override
  State<HxCheckBox> createState() => _HxCheckBoxState();
}

class _HxCheckBoxState extends State<HxCheckBox> {
  late bool isChecked;
                ...
                children: [
                  Transform.scale(
                    ...
                    child: Checkbox(
                        ...
                        onChanged: !widget.enable?null:(val) {
    ...
    return GestureDetector(
        ...
        child: widget.iconLeft!
            ? Row(
                ...
                mainAxisSize: widget.mainAxisSize,
                children: [
                    (isChecked ? widget.checkIcon : widget.uncheckedIcon) ??
                        const SizedBox(),
                    widget.text ?? const SizedBox(),
                  ])
            : Row(
