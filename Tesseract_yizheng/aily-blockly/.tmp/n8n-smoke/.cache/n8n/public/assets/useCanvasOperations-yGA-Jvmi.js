...
import { C as computed, Cn as toDisplayString, D as createElementBlock, G as nextTick, Gt as unref, It as ref, M as createVNode, P as defineComponent, T as createBlock, _ as Fragment, at as renderSlot, bt as withCtx, ct as resolveDynamicComponent, et as openBlock, it as renderList, j as createTextVNode, vn as normalizeClass, w as createBaseVNode, zt as shallowRef } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { A as useLocalStorage, S as useClipboard, gt as useI18n } from "./_MapCache-BpDQM3eE.js";
import { Nt as useRoute, Pt as useRouter, Rt as require_markdown_it_link_attributes, Wt as createEventBus } from "./src-Hou_zQaF.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { At as useNodeHelpers, Ct as useWorkflowHelpers, En as getNewNodePosition, Et as useTagsStore, Ft as injectWorkflowState, It as useWorkflowState, On as getNodesGroupSize, Pt as useNDVStore, Rt as useProjectsStore, S as useNodeTypesStore, Zr as isValidNodeConnectionType, _n as GRID_SIZE, ai as AddConnectionCommand, ar as useCanvasStore, bn as doRectsOverlap, di as RemoveConnectionCommand, dn as useTemplatesStore, fi as RemoveNodeCommand, fn as CONFIGURABLE_NODE_SIZE, gi as useSettingsStore, gn as DEFAULT_VIEWPORT_BOUNDARIES, hn as DEFAULT_NODE_SIZE, ii as useHistoryStore, ir as useExternalHooks, jr as v4_default, jt as useTelemetry, mi as ReplaceNodeParametersCommand, mn as CONFIGURATION_NODE_SIZE, n as useUIStore, nr as useToast, o as useWorkflowsStore, oa as tryToParseNumber, oi as AddNodeCommand, on as useFocusPanelStore, ot as useDataSchema, pi as RenameNodeCommand, ri as CanvasNodeRenderType, ta as isPresent, ti as CanvasConnectionMode, tt as useCredentialsStore, u as isChatNode, ui as MoveNodeCommand, v as getExecutionErrorToastConfiguration, vn as PUSH_NODES_OFFSET, vr as usePostHog, xn as generateOffsets } from "./ui.store-Cpjm3B-h.js";
import { Ba as NodeConnectionTypes, Fs as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Io as VIEWS, Ji as getNodeOutputs, Ki as getConnectionTypes, Ms as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Ns as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Ps as LOCAL_STORAGE_LOGS_PANEL_OPEN, Sa as isCommunityPackageName, Ui as generateNodesGraph, Yi as getNodeParameters, cr as UPDATE_WEBHOOK_ID_NODE_TYPES, ea as getSubworkflowId, hi as require_cloneDeep, ic as CANVAS_ZOOMED_VIEW_EXPERIMENT, in as FORM_TRIGGER_NODE_TYPE, lc as NDV_IN_FOCUS_PANEL_EXPERIMENT, nr as STICKY_NODE_TYPE, qi as getNodeInputs, ur as WEBHOOK_NODE_TYPE, vc as EnterpriseEditionFeature, wi as require__baseUniq, xa as deepCopy, xn as MCP_TRIGGER_NODE_TYPE } from "./constants-CpkFUv1J.js";
import { A as defineStore, T as useRootStore } from "./_baseOrderBy-FBF5m4XW.js";
import { t as useExecutionsStore } from "./executions.store-sAORumYe.js";
...
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-5q3Oj_ss.js";
import { t as core_default } from "./core-Dy8Lxir_.js";
import { a as bash, i as javascript, n as typescript, r as python, t as xml } from "./xml-BAK5rppv.js";
import { t as VueMarkdown_default } from "./VueMarkdown-vbbmgjFV.js";
...
var Button_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(resolveDynamicComponent(__props.element), { class: normalizeClass(["chat-button", buttonTypeClass.value]) }, {
...
var MessageWithButtons_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", null, [createVNode(MarkdownRenderer_default, { text: __props.text }, null, 8, ["text"]), createBaseVNode("div", { class: normalizeClass(_ctx.$style.buttons) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.buttons, (button) => {
...
var MessageWithButtons_vue_vue_type_style_index_0_lang_module_default = { buttons: "_buttons_x6kgq_123" };
