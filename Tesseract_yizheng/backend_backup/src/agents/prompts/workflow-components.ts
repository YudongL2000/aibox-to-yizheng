/**
 * [INPUT]: 依赖 hardware-endpoint-defaults.ts 的 endpoint 真相源
 * [OUTPUT]: 对外提供 WorkflowComponent/WorkflowNodeConfig 类型与 WORKFLOW_COMPONENTS 组件库
 * [POS]: agents/prompts 的组件库定义，用于系统提示词渲染，默认 URL 统一走 env-backed expression helper
...
import {
  AI_ASR_URL,
  AI_LLM_URL,
  AI_STRUCTBERT_EMOTION_URL,
  AI_TTS_URL,
  AI_YOLOV8_GESTURE_URL,
  AI_YOLOV8_IDENTIFY_URL,
  buildN8nEnvBackedUrlExpression,
  ROBOT_ARM_ACTION_URL,
  ROBOT_BASE_MOVE_URL,
  ROBOT_CAMERA_SNAPSHOT_URL,
  ROBOT_HAND_GESTURE_URL,
  ROBOT_MIC_CAPTURE_URL,
  ROBOT_SCREEN_EMOJI_URL,
  ROBOT_SPEAKER_PLAY_URL,
    ...
    nodes: [
      {
        ...
        parameters: {
          method: 'POST',
          url: buildN8nEnvBackedUrlExpression('ASR_API_URL', AI_ASR_URL),
          options: { timeout: 60000 },
        },
      },
      {
    ...
    nodes: [
      {
        ...
        parameters: {
          method: 'POST',
          url: buildN8nEnvBackedUrlExpression('LLM_API_URL', AI_LLM_URL),
          options: { timeout: 60000 },
        },
      },
      {
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        parameters: {
          method: 'POST',
          url: buildN8nEnvBackedUrlExpression('TTS_API_URL', AI_TTS_URL),
          options: { timeout: 60000 },
        },
      },
      {
