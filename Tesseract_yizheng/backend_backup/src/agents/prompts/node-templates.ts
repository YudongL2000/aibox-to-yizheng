/**
 * [INPUT]: 依赖节点 type 查询参数模板、hardware-endpoint-defaults.ts 的 placeholder URL，以及 utils/code-node-parameters.ts 的 code 节点模板
 * [OUTPUT]: 对外提供 getNodeParameterTemplate 节点参数空模板
 * [POS]: prompts 的参数模板中心，统一约束 parameters 只保留结构，避免 httpRequest placeholder URL 分叉
 * [PROTOCOL]: 变更时更新此头部，然后检查 CLAUDE.md
 */

import { buildExecutableCodeNodeParameters } from '../../utils/code-node-parameters';
import { HTTP_REQUEST_PLACEHOLDER_URL } from '../hardware-endpoint-defaults';
...
export const NODE_PARAMETER_TEMPLATES: Record<string, NodeParameterTemplate> = {
  ...
  'n8n-nodes-base.httpRequest': {
    parameters: {
      method: 'POST',
      url: HTTP_REQUEST_PLACEHOLDER_URL,
      options: {},
    },
    typeVersion: 4.3,
  },
