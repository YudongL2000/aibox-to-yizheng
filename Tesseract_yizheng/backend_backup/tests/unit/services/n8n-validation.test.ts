...
describe('n8n-validation', () => {
  ...
  describe('validateWorkflowStructure', () => {
    ...
    it('should reject single webhook node workflow', () => {
      const workflow = {
        name: 'Webhook Only',
        nodes: [{
          id: 'webhook-1',
      ...
      const errors = validateWorkflowStructure(workflow as any);
      expect(errors.some(e => e.includes('Single-node workflows are invalid for Tesseract'))).toBe(true);
    });
  ...
  describe('getWorkflowFixSuggestions', () => {
    ...
    it('should suggest fixes for single-node workflows', () => {
      const errors = ['Single-node workflows are invalid for Tesseract'];
      const suggestions = getWorkflowFixSuggestions(errors);
    ...
    it('should handle multiple error types', () => {
      const errors = [
        ...
        'Single-node workflows are invalid for Tesseract',
