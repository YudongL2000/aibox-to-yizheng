...
<template>
	...
	>
		...
		<div class="custom-node processor-node">
		<!-- 左侧蓝色竖线 -->
		...
		<div class="header">
			<div class="header-left">
				<!-- 蓝色处理器图标 -->
				<N8nIcon icon="microchip" size="small" class="type-icon" />
				<!-- PROCESSOR 标签 -->
				<span class="type-label">PROCESSOR</span>
			</div>
			<!-- 右上角淡蓝色点 -->
		...
		<div class="content">
			...
			<!-- 副标题：小号灰色 -->
			<div class="subtitle">{{ options.subtitle || 'FN: Processor' }}</div>
		</div>
		</div>
	</N8nTooltip>
</template>
