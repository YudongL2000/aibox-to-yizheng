...
class FieldMonacoEditor extends Blockly.FieldTextInput {
    ...
    override showEditor_(e = undefined, _quietInput = undefined) {
        ...
        style.border = '1px solid var(--shell-shell-divider)';
        style.boxShadow = '0 0 8px 2px var(--shell-shell-shadow)';
        style.zIndex = 100;
        ...
        header.style.backgroundColor = 'var(--shell-panel)';
        header.style.borderBottom = '1px solid var(--shell-shell-divider)';
        ...
        closeBtn.style.backgroundColor = 'var(--shell-shell-success)';
        closeBtn.style.color = 'var(--text-inverse)';
