import { ChangeDetectorRef, ChangeDetectionStrategy, Component, ViewChild, ElementRef, AfterViewInit, OnDestroy, viewChild, viewChildren, signal, effect, untracked, DestroyRef, inject, Input } from '@angular/core';
