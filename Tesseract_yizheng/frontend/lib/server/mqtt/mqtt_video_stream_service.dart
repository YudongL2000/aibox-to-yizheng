...
class MqttVideoStreamService {
  ...
  Future<bool> connectAndSubscribe() async {
    ...
    if (!MqttDeviceConfig.isConfigured) return false;
    _isConnecting = true;
    try {
      final clientId =
          '${MqttVideoStreamConfig.clientIdPrefix}_${DateTime.now().millisecondsSinceEpoch}';
      ...
      _client!
          .subscribe(MqttVideoStreamConfig.topicCommand, MqttQos.atLeastOnce);
