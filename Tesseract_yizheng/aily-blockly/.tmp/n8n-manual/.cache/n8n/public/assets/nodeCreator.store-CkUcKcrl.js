...
import { _ as require_toString, p as require_get, v as require__arrayMap } from "./src-Hou_zQaF.js";
import { $ as require__createCompounder, $r as isVueFlowConnection, B as transformNodeType, D as flattenCreateElements, E as finalizeItems, I as searchNodes, M as isAINode, O as getAiTemplatesCallout, P as prepareCommunityNodeDetailsViewStack, Pi as getThemedValue, Pt as useNDVStore, R as sortNodeCreateElements, S as useNodeTypesStore, To as STORES, Z as require_upperFirst, ar as useCanvasStore, dn as useTemplatesStore, gi as useSettingsStore, ir as useExternalHooks, j as groupItemsInSections, jr as v4_default, jt as useTelemetry, n as useUIStore, o as useWorkflowsStore, ti as CanvasConnectionMode, w as useEvaluationStore, z as subcategorizeItems } from "./ui.store-Cpjm3B-h.js";
import { $ as AI_CATEGORY_RETRIEVERS, $a as EVALUATION_TRIGGER_NODE_TYPE, $n as SPLIT_IN_BATCHES_NODE_TYPE, At as AI_TRANSFORM_NODE_TYPE$1, Ba as NodeConnectionTypes, Ct as TEMPLATE_CATEGORY_AI, Dt as AGGREGATE_NODE_TYPE, Ei as require__arrayIncludes, G as AI_CATEGORY_CHAINS, Gn as SCHEDULE_TRIGGER_NODE_TYPE, Gt as DATETIME_NODE_TYPE, Hn as REMOVE_DUPLICATES_NODE_TYPE, Ht as CRYPTO_NODE_TYPE, It as CODE_NODE_TYPE, J as AI_CATEGORY_LANGUAGE_MODELS, Jn as SET_NODE_TYPE, K as AI_CATEGORY_DOCUMENT_LOADERS, Ka as AI_TRANSFORM_NODE_TYPE, Lt as COMPRESSION_NODE_TYPE, M as CUSTOM_API_CALL_KEY, Ot as AI_CODE_NODE_TYPE, Pt as CHAT_TRIGGER_NODE_TYPE, Q as AI_CATEGORY_OUTPUTPARSER, Rt as CONVERT_TO_FILE_NODE_TYPE, Sa as isCommunityPackageName, Sn as MERGE_NODE_TYPE, Ti as require__arrayIncludesWith, Tt as TRIGGER_NODE_CREATOR_VIEW, Un as RSS_READ_NODE_TYPE, W as AI_CATEGORY_AGENTS, Wt as DATA_TABLE_NODE_TYPE, X as AI_CATEGORY_MEMORY, Xt as EMAIL_SEND_NODE_TYPE, Y as AI_CATEGORY_MCP_NODES, Yt as EMAIL_IMAP_NODE_TYPE, _o as require__cacheHas, _t as HUMAN_IN_THE_LOOP_CATEGORY, bn as MARKDOWN_NODE_TYPE, cn as HTTP_REQUEST_NODE_TYPE, ct as AI_SUBCATEGORY, en as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, er as SPLIT_OUT_NODE_TYPE, et as AI_CATEGORY_ROOT_NODES, ft as CORE_NODES_CATEGORY, gn as LIMIT_NODE_TYPE, gr as XML_NODE_TYPE, gt as HITL_SUBCATEGORY, ht as HELPERS_SUBCATEGORY, in as FORM_TRIGGER_NODE_TYPE, it as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, lt as AI_UNCATEGORIZED_CATEGORY, mt as FLOWS_CONTROL_SUBCATEGORY, nn as FILTER_NODE_TYPE, nt as AI_CATEGORY_TOOLS, ot as AI_NODE_CREATOR_VIEW, pt as DEFAULT_SUBCATEGORY, q as AI_CATEGORY_EMBEDDING, qi as getNodeInputs, qt as EDIT_IMAGE_NODE_TYPE, rr as SUMMARIZE_NODE_TYPE, rt as AI_CATEGORY_VECTOR_STORES, sn as HTML_NODE_TYPE, st as AI_OTHERS_NODE_CREATOR_VIEW, ti as require__baseFlatten, tn as EXTRACT_FROM_FILE_NODE_TYPE, tt as AI_CATEGORY_TEXT_SPLITTERS, un as IF_NODE_TYPE, ur as WEBHOOK_NODE_TYPE, ut as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, vo as require__SetCache, vt as NODE_CREATOR_OPEN_SOURCES, wt as TRANSFORM_DATA_SUBCATEGORY, xt as REGULAR_NODE_CREATOR_VIEW, yn as MANUAL_TRIGGER_NODE_TYPE, yt as OTHER_TRIGGER_NODES_SUBCATEGORY } from "./constants-CpkFUv1J.js";
import { T as require__baseUnary, r as require__baseRest, u as require_isArrayLikeObject } from "./merge-6pup5Abj.js";
import { A as defineStore } from "./_baseOrderBy-FBF5m4XW.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString } from "./canvas.utils-5q3Oj_ss.js";
