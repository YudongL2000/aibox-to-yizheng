...
class _TableViewState<T> extends State<TableView> {
  ...
  List<Widget> _buildRowLines() {
    ...
    final Color resolvedDividerColor =
        widget.dividerColor ?? context.spatial.palette.borderSolid;
            ...
            ScrollConfiguration(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      widget.buildTableHeaderStyle?.call(context) ??
                          const SizedBox(),
                      ..._buildRowLines(),
                    ],
                  ),
        ...
        Expanded(
            child: ListView.separated(
                ...
                separatorBuilder: (context, index) {
                  final Color resolvedDividerColor = widget.dividerColor ??
                      context.spatial.palette.borderSolid;
                  final divider = Container(
                    ///修复 web html 像素丢失问题
                    height: widget.dividerHeight,
                    color: resolvedDividerColor,
...
class TabRow extends StatelessWidget {
  ...
  Widget _createRowLine() {
    final Color resolvedDividerColor =
        dividerColor ?? context.spatial.palette.textSecondary;
  ...
  List<Widget> _buildCells(List<int> cellWidget) {
    final Color cellBackground = cellItem.background ??
        context.spatial.surface(SpatialSurfaceTone.panel).withValues(alpha: 0);
    List<Widget> cells = [];
