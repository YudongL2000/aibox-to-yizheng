...
class ConfirmNodeRequest {
  ...
  final String nodeName; // 推荐传 currentNode.name（FACE-NET 节点如 set_face_net_recognition_liu）
...
class AgentConfirmNodeApi {
  ...
  AgentConfirmNodeApi() : _dio = Dio(BaseOptions(
  ...
  Future<ConfirmNodeResponse?> confirmNode({
    ...
    try {
      ...
      final url = '${HttpConfig_AgentConfirmNode.baseUrl}${HttpConfig_AgentConfirmNode.confirmNode}';
