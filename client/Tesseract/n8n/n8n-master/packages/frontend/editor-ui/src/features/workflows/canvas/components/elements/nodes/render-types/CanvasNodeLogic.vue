...
<template>
	...
	>
		...
		<div class="custom-node logic-node">
		<!-- 左侧橙色竖线 -->
		...
		<div class="header">
			<div class="header-left">
				<!-- 橙色逻辑图标 -->
				<N8nIcon icon="code-branch" size="small" class="type-icon" />
				<!-- P LOGIC 标签 -->
				<span class="type-label">P LOGIC</span>
			</div>
			<!-- 右上角淡橙色点 -->
		...
		<div class="content">
			...
			<!-- 副标题：小号灰色 -->
			<div class="subtitle">{{ options.subtitle || 'FN: Logic' }}</div>
		</div>
		</div>
	</N8nTooltip>
</template>
...
.logic-node {
	...
	.corner-bracket {
		...
		&.corner-top-left {
			...
			box-shadow:
				inset 0 0 4px rgba(249, 115, 22, 0.3),
