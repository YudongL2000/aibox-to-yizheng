...
import { G as isObject, H as directiveHooks, K as noop, M as useResizeObserver, Q as toRef, T as useElementSize, U as isClient, W as isIOS, _t as I18nT, ct as isVue2, et as toValue$1, g as onClickOutside, gt as useI18n, it as useThrottleFn, nt as tryOnScopeDispose, q as notNullish, rt as useDebounceFn, tt as tryOnMounted } from "./_MapCache-BpDQM3eE.js";
import { Ai as N8nText_default, F as N8nRadioButtons_default, Gt as N8nIconButton_default, Lt as N8nTooltip_default, Ni as N8nIcon_default, Nt as useRoute, ht as N8nBlockUi_default, in as ElCollapseTransition, ji as N8nButton_default, k as N8nTabs_default, ki as N8nCallout_default, p as require_get, u as N8nInlineTextEdit_default, z as N8nNotice_default } from "./src-Hou_zQaF.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { Ao as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, At as useNodeHelpers, C as useActionsGenerator, Ct as useWorkflowHelpers, Do as COMMUNITY_NODES_INSTALLATION_DOCS_URL, F as removePreviewToken, Ft as injectWorkflowState, Pt as useNDVStore, Rt as useProjectsStore, S as useNodeTypesStore, gi as useSettingsStore, ii as useHistoryStore, ir as useExternalHooks, jt as useTelemetry, n as useUIStore, nr as useToast, o as useWorkflowsStore, pi as RenameNodeCommand, tt as useCredentialsStore, ua as importCurlEventBus, yr as useUsersStore, zt as ProjectTypes } from "./ui.store-Cpjm3B-h.js";
import { S as TitledList_default, b as NodeCredentials_default, d as collectParametersByTab, f as collectSettings, h as nameIsParameter, m as getNodeSettingsInitialValues, p as createCommonNodeSettings, t as ParameterInputList_default, u as useNodeSettingsParameters, x as useNodeCredentialOptions } from "./ParameterInputList-BXbARWot.js";
import { n as ElRow, t as ElCol } from "./col-B7VKwEsY.js";
import { Ba as NodeConnectionTypes, In as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, Io as VIEWS, M as CUSTOM_API_CALL_KEY, Pt as CHAT_TRIGGER_NODE_TYPE, Sa as isCommunityPackageName, Ut as DATA_TABLE_NODES, Yi as getNodeParameters, d as CUSTOM_NODES_DOCS_URL, in as FORM_TRIGGER_NODE_TYPE, l as BUILTIN_NODES_DOCS_URL, oo as OPEN_AI_API_CREDENTIAL_TYPE, qi as getNodeInputs, s as BASE_NODE_SURVEY_URL, v as NPM_PACKAGE_DOCS_BASE_URL, xa as deepCopy, xn as MCP_TRIGGER_NODE_TYPE, zn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES } from "./constants-CpkFUv1J.js";
import { t as useDebounce } from "./useDebounce-DcGabTQy.js";
import { t as useClipboard } from "./useClipboard-DYfn4Fr1.js";
import { n as ndvEventBus } from "./assistant.store-CVH65TPR.js";
...
import { a as useInstallNode, i as useInstalledCommunityPackage, n as CommunityNodeFooter_default, r as ContactAdministratorToInstall_default, t as CommunityNodeUpdateInfo_default } from "./CommunityNodeUpdateInfo-YKV6jXcM.js";
import { t as NodeIcon_default } from "./NodeIcon-C7QOv9AW.js";
import { n as NodeExecuteButton_default } from "./VirtualSchema-C_ZNqXCX.js";
import { t as useDataTableStore } from "./dataTable.store-Ba2kBOzA.js";
