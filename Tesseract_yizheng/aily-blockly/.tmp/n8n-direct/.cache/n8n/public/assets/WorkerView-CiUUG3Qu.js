import { C as computed, Cn as toDisplayString, D as createElementBlock, E as createCommentVNode, Gt as unref, It as ref, J as onBeforeUnmount, M as createVNode, P as defineComponent, T as createBlock, Z as onMounted, _ as Fragment, at as renderSlot, bt as withCtx, et as openBlock, it as renderList, j as createTextVNode, q as onBeforeMount, st as resolveDirective, vn as normalizeClass, w as createBaseVNode, xt as withDirectives } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { gt as useI18n } from "./_MapCache-BpDQM3eE.js";
import { Ai as N8nText_default, Kt as N8nActionBox_default, Lt as N8nTooltip_default, Mi as N8nSpinner_default, Ni as N8nIcon_default, Oi as N8nHeading_default, Pt as useRouter, mt as N8nCard_default } from "./src-Hou_zQaF.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { gi as useSettingsStore, in as useDocumentTitle, jt as useTelemetry, nr as useToast } from "./ui.store-Cpjm3B-h.js";
...
import { t as usePushConnectionStore } from "./pushConnection.store-Cqs8TrY7.js";
import { t as sortByProperty } from "./sortByProperty-DDQ5Sna3.js";
import "./banners.store-DAU8T63l.js";
import "./aiTemplatesStarterCollection.store-Bif62YNR.js";
import "./readyToRun.store-qwoH_Rfl.js";
import { n as Chart } from "./dist-fyDwgpQo.js";
import { n as WORKER_HISTORY_LENGTH, r as useOrchestrationStore, t as usePushConnection } from "./usePushConnection-CO-Qe8Ur.js";
			...
			return openBlock(), createBlock(WorkerAccordion_default, {
				...
				content: withCtx(() => [props.items.length > 0 ? (openBlock(), createElementBlock("div", {
					...
					return openBlock(), createElementBlock("div", {
						...
						createBaseVNode("a", { href: "/workflow/" + item.workflowId + "/executions/" + item.executionId }, " Execution " + toDisplayString(item.executionId) + " - " + toDisplayString(item.workflowName), 9, _hoisted_1$5),
						createVNode(unref(N8nText_default), {
							color: "text-base",
							size: "small",
							align: "left"
			...
			return openBlock(), createBlock(WorkerAccordion_default, {
				...
				content: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style["accordion-content"]) }, [
					...
					createBaseVNode("table", null, [createBaseVNode("tbody", null, [
						__props.worker.isInContainer ? (openBlock(), createElementBlock("tr", _hoisted_1$3, [_cache[2] || (_cache[2] = createBaseVNode("th", null, "Constraint: (process.constrainedMemory)", -1)), createBaseVNode("td", null, toDisplayString(unref(memAsMb)(props.worker.process.memory.constraint)) + "MB", 1)])) : createCommentVNode("", true),
...
var PushConnectionTracker_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("span", null, [showConnectionLostError.value ? (openBlock(), createElementBlock("div", _hoisted_1$2, [createVNode(unref(N8nTooltip_default), { placement: "bottom-end" }, {
